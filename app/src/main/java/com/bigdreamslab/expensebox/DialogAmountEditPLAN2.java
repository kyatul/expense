...
public class DialogAmountEditPLAN2 extends FragmentActivity implements View.OnClickListener,DatePickerDialog.OnDateSetListener,TimePickerDialog.OnTimeSetListener{

    EditText etAmtEditTotal,etAmtEditDesc,etAmtEditDay,etAmtEditTime;
    LinearLayout lvAmtEditDelete,lvAmtEditDone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_amount_edit_plan2);
        ...
        etAmtEditTotal = (EditText) findViewById(R.id.etAmountAmtEdit1);
        etAmtEditDesc = (EditText) findViewById(R.id.etDescriptionAmtEdit1);
        etAmtEditDay = (EditText) findViewById(R.id.etDayAmtEdit1);
        etAmtEditTime = (EditText) findViewById(R.id.etTimeAmtEdit1);

        lvAmtEditDelete = (LinearLayout) findViewById(R.id.llDeleteAmtEdit1);
        lvAmtEditDone = (LinearLayout) findViewById(R.id.llSaveAmtEdit1);

        ivAmtEditDay = (ImageView) findViewById(R.id.ivCalendarAmtEdit1);
        ivAmtEditTime = (ImageView) findViewById(R.id.ivTimeAmtEdit1);

        spAmtEditCat = (Spinner) findViewById(R.id.spAmtEditCat1);

        ivAmtEditDay.setOnClickListener(this);
        ivAmtEditTime.setOnClickListener(this);

        lvAmtEditDone.setOnClickListener(this);
        lvAmtEditDelete.setOnClickListener(this);

        etAmtEditTime.setOnClickListener(this);
        etAmtEditDay.setOnClickListener(this);
        etAmtEditTotal.setOnClickListener(this);

        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.spinner_item, categoryNames);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.ivCalendarAmtEdit1:
            case R.id.etDayAmtEdit1:
            ...
            case R.id.ivTimeAmtEdit1:
            case R.id.etTimeAmtEdit1:
